...
vair=0.000000000001:0.030303:1;%rango velocidad del aire
...
tr=[10.5,17.5,25,32.5,40]; %rango temp radiante media
...
tcl(1,j)=fsolve(@funtlc_vair,tclini(1,i),options,vair(1,j),j,i);
...
pmv7(1,j)=fcl(1,i).*hc(1,j).*(tcl(1,j)-ta(1,i));%heat loss by convection
