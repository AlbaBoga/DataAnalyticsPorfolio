...
rh=30:1.212121:70; %rango humedad relativa
...
tcl=fsolve(@funtlc_pa,tclini(1,i),options,vair(1,i),i);
...
pmv6=3.96*0.00000001.*fcl(1,i).*(((tcl+273))^4-((tr(1,i)+273)).^4);%heat loss by radiation
pmv7=fcl(1,i).*hc(1,i).*(tcl-ta(1,i));%heat loss by convection

pmv(1,j)=pmv1.*((m(1,i)-w)-pmv2(1,j)-pmv3-pmv4(1,j)-pmv5-pmv6-pmv7);
